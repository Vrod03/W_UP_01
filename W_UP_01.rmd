...
The probability of getting a result like this is 0.000009421 if there is no difference between line players and skill doing push ups. In my opinion the line players are no where nearly skilled in doing push ups as the killed players. I reject the hypothesis in this case beacauseue there is a huge difference in the amount of push ups the skill players did compared to the line players.
